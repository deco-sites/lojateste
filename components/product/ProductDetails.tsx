		...
		<>
			...
			{reviews?.length && (
				<div class="mt-4 sm:mt-6">
					<span class="text-sm">
						<details>
							<summary class="cursor-pointer">Avaliações</summary>
							<div class="ml-2 mt-2">
								{reviews.map((review) => {
									const author = review.author?.[0] ?? { name: "anonymous" };
									...
									return (
										<div class="flex flex-col gap-1">
											<div class="flex gap-2 items-center mb-2">
												<span class="font-medium text-xl">{author.name}</span>
											...
											<div class="ml-2 mt-2">{review.reviewBody}</div>
										</div>
									);
								})}
							</div>
